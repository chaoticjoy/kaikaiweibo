...
<div class="single">
	...
	<img onclick="gui.openUserInfo('{$item['status']['user_concise']['id']}','{$item['status']['user_concise']['screen_name']}','kk')" src="{$item['status']['user_concise']['profile_image_url']}" class="single-avatar"/>
