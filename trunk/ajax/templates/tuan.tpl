{if $tuan['goods']['goods_title']}<div class="single">
	...
	<div class="single-operate"><span><a href="{$tuan['goods']['goods_site_url']}" target="_blank">详情</a></span> | <span onclick="gui.sendMsg('tuangou','{$tuan['goods']['goods_sp_name']}'+' '+'{$tuan['goods']['goods_site_url']}',{$tuan['goods']['goods_image_url']});">分享</span></div>
	<br class="clean"/>
</div>
{else}
<div class="single">
