{foreach from=$friends_timeline item=item}
			<div class="single">
				...
				<img onclick="gui.openImage(this,'kk')" src="{$item['status']['photo_thumb_url']}" class="thumbnail">
				{/if}
				...
				<img onclick="gui.openImage(this,'kk')" src="{$item['status']['in_reply_to_status']['photo_thumb_url']}" class="thumbnail">
				{/if}
				</div>
				{/if}
				<br class="clean" />
